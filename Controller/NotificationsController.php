 ...
 */
	...
	public function seeall() {
		$this->Notification->recursive = 0;
		$options = array('conditions' => array('Notification.user_id'=> $this->Auth->user('id')),'order'=>'Notification.id desc');
		$this->set('notifications', $this->Notification->find('all', $options));
