<div class="resumes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('areas'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($resume['Resume']['areas']); ?>&nbsp;</td>
		<td><?php echo h($resume['Resume']['resume']); ?>&nbsp;</td>
		<td><?php echo h($resume['Resume']['contact']); ?>&nbsp;</td>
